...
export const productList = [
  ...
  { label: 'Cloak Spray Oil™', nutrientContent: {}, description: 'A premium spreader/sticker blend of cold-pressed canola oil and omega-3 fish oil. Enhances foliar nutrient absorption and spray efficiency while minimizing leaf burn risk.' },
